<?php 
    ...
    if (isset($_POST['empty_cart'])) {
        ...
        if ($varify_empty_item->rowCount() > 0) {
            ...
            $success_msg = 'keranjang anda berhasil dihapus';
        } else {
            $warning_msg[] = 'keranjang anda masih kosong';
        }
    }
?>
<style type="text/css">
...
<head>
    ...
    <title>Coffee Shop - halaman Keranjang</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="title2">
            <a href="home.php">Home</a><span>/Keranjang</span>
        </div>
        <section class="products">
            <h1 class="title">produk yang ada di keranjang</h1>
            <div class="box-container">
                ...
                <?php 
                        ...
                        echo '<p class="empty">keranjang anda masih kosong</p>';
                    }
                ?>
            </div>
            <?php 
